...
import (
	...
	"github.com/gitlayzer/upgrade-controller/internal/controller"
...
func init() {
	...
	utilruntime.Must(devopsengineercomcnv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4bc71969.devops-engineer.com.cn",
